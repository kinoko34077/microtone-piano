...
const analyzedSampleRows: PianoSampleRow[] = [
  ...
  ['FL Piano (8).wav', 958.7, 'A#5'],
  ['FL Piano (9).wav', 918.75, 'A#5'],
  ...
  ['FL Piano (30).wav', 668.18, 'E5'],
  ['FL Piano (31).wav', 668.18, 'E5'],
